...
return [
    'create' => [
        ...
        'subtitle' => 'Start the move-out process for {name}',
        'tenant_label' => 'Tenant',
        'unit_label' => 'Unit',
        'unit_prefix' => 'Unit',
        ...
        'details_heading' => 'Move-Out Details',
        'notice_date_label' => 'Notice Date *',
        'notice_date_help' => 'Date tenant gave notice to move out',
        'intended_date_label' => 'Intended Move-Out Date *',
        'intended_date_help' => 'Expected date tenant will vacate',
        'reason_label' => 'Reason for Moving (Optional)',
        'reason_placeholder' => 'e.g., Relocation, end of lease term, etc.',
        'next_heading' => 'What happens next?',
        'next_step_1' => 'Move-out notice is recorded',
        'next_step_2' => 'When tenant vacates, you\'ll conduct a move-out inspection',
        'next_step_3' => 'Record any deductions (damages, unpaid rent, etc.)',
        'next_step_4' => 'Calculate and settle the deposit refund',
        'next_step_5' => 'Unit becomes vacant and available for new tenant',
        'cancel' => 'Cancel',
        'submit' => 'Start Move-Out Process',
