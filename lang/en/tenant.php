...
return [
    ...
    'statement' => [
        ...
        'credit_note_description' => 'Credit note :number',
        'wallet_credit' => 'Wallet credit',
        'wallet_debit' => 'Wallet applied',
        'col_date' => 'Date',
    ...
    'wallet' => [
        'title' => 'My wallet',
        'subtitle' => 'Your credit balance and how it has moved',
        'no_lease' => 'No active lease found.',
        'balance_heading' => 'Balance',
        'no_balance' => 'No wallet credit yet.',
        'ledger_heading' => 'Recent activity',
        'no_ledger' => 'No wallet activity yet.',
        'col_date' => 'Date',
        'col_type' => 'Type',
        'col_amount' => 'Amount',
        'col_reason' => 'Reason',
        ...
        'type_credit' => 'Credit',
        'type_debit' => 'Applied',
        'apply_heading' => 'Apply credit to an invoice',
        'no_invoices' => 'No outstanding invoices.',
        'apply_amount' => 'Amount (optional)',
        'apply_button' => 'Apply credit',
        'applied' => ':amount credit applied to invoice :invoice.',
        'nothing_applied' => 'No credit could be applied to that invoice.',
    ],
];
