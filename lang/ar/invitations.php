...
return [
    ...
    'accept_existing' => [
        'head_title' => 'قبول دعوة الحارس',
        'title' => 'دعوة حارس',
        'subtitle' => 'تمت دعوتك لتصبح حارس عقار',
        'invited_by' => 'دعاك',
        'property' => 'العقار',
        'expires_on' => 'تنتهي الصلاحية في',
        'info_intro' => 'بقبولك هذه الدعوة، سيتم تحويل حسابك إلى دور',
        'info_role' => 'حارس',
        'info_middle' => '. ستحصل على صلاحية إدارة عمليات',
        'processing' => 'جارٍ المعالجة...',
        'accept' => 'قبول الدعوة',
        'decline' => 'رفض',
        'decline_confirm' => 'هل أنت متأكد أنك تريد رفض هذه الدعوة؟',
    ],
];
