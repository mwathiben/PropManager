...
use App\Services\Dashboard\KycStatsCalculator;
use App\Services\Dashboard\LandlordMetricsCalculator;
use App\Services\Dashboard\PortfolioOverviewBuilder;
use App\Services\Dashboard\SuperAdminMetricsCalculator;
use App\Services\Dashboard\TenantDashboardBuilder;
...
class DashboardService
{
    ...
    public function __construct(
        ...
        private SuperAdminMetricsCalculator $superAdmin = new SuperAdminMetricsCalculator,
        private PortfolioOverviewBuilder $portfolio = new PortfolioOverviewBuilder,
        private LandlordMetricsCalculator $landlordMetrics = new LandlordMetricsCalculator,
        private TenantDashboardBuilder $tenantDashboard = new TenantDashboardBuilder,
    ) {}
    ...
    {
        return $this->portfolio->forLandlord($landlord);
    }
    ...
    private function buildLandlordDashboardData(User $landlord, Request $request): array
    {
        ...
        $metricsData = $this->landlordMetrics->calculate(
            $allUnits,
            $wings,
            $activeBuilding,
            $hasWings,
    ...
    {
        return $this->tenantDashboard->forTenant($tenant);
    }
    ...
    {
        return $this->kyc->forLeases($leaseIds);
    }
