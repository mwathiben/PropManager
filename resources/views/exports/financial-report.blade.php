    ...
    <div class="section">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $row['month'] }}</td>
                    <td class="text-right">{{ number_format($row['invoiced'], 0) }}</td>
                    <td class="text-right">{{ number_format($row['collected'], 0) }}</td>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="badge {{ $row['rate'] >= 80 ? 'badge-success' : ($row['rate'] >= 60 ? 'badge-warning' : 'badge-danger') }}">
                            {{ $row['rate'] }}%
                        </span>
                    </td>
                </tr>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <span class="badge {{ $building['occupancy_rate'] >= 80 ? 'badge-success' : ($building['occupancy_rate'] >= 50 ? 'badge-warning' : 'badge-danger') }}">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right">{{ number_format($data['expenses_by_category']['total'], 0) }}</td>
