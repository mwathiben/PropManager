        ...
        <div class="bg-gray-50 rounded-lg p-4 mb-6 border border-gray-200">
            <div class="flex flex-wrap gap-4">
                <div class="flex-1 min-w-[200px]">
                    <div class="relative">
                        <input v-model="search" @keyup.enter="applyFilters" type="text" :placeholder="t('tenants_history_tab.search_placeholder')" :aria-label="t('tenants_history_tab.search_placeholder')"
                ...
                <select v-model="buildingId" @change="applyFilters" :aria-label="t('tenants_history_tab.all_buildings')" class="border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
