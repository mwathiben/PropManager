        ...
        <Teleport to="body">
            <div v-if="showGenerateModal" class="fixed inset-0 z-50 overflow-y-auto">
                <div class="flex items-center justify-center min-h-screen px-4">
                    <div class="fixed inset-0 bg-black opacity-30" role="button" tabindex="0" @click="showGenerateModal = false" @keydown.enter="showGenerateModal = false" @keydown.space.prevent="showGenerateModal = false"></div>
