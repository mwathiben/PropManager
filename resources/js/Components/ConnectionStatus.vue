...
const statusConfig = computed(() => {
    const configs = {
        ...
        reconnecting: {
            dot: 'bg-amber-500',
            label: `Reconnecting (${reconnectAttemptCount.value}/${maxReconnectAttempts})...`,
            animate: true,
        },
        disconnected: {
            dot: 'bg-red-500',
    ...
    <div class="relative group">
        <button
            ...
            :class="[
                ...
                !isConnected ? 'cursor-pointer hover:ring-2 hover:ring-offset-1 hover:ring-gray-300' : 'cursor-default'
            ]"
